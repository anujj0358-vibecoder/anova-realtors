      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${scrolled ? "bg-background/90 backdrop-blur-md border-b border-white/5 py-4" : "bg-transparent py-6"}`}>
        <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
          <div className="font-serif text-2xl font-bold tracking-widest text-white flex items-center gap-2">
            <span className="text-primary">A</span>NOVA <span className="font-sans font-light tracking-[0.3em] text-xs uppercase opacity-80 mt-1 ml-2">Realtors</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <AnimatePresence>
              {properties[listingMode].map((property, idx) => (
                ...
                >
                  <Card className="bg-background border-none rounded-none overflow-hidden group cursor-pointer h-full flex flex-col hover:-translate-y-2 transition-transform duration-500" data-testid={`card-property-${property.id}`}>
                    ...
                    <CardContent className="p-8 flex flex-col flex-grow border border-t-0 border-white/5 group-hover:border-primary/30 transition-colors duration-500 group-hover:shadow-[0_20px_60px_rgba(201,168,76,0.08)]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {locations.map((loc) => (
              <motion.div
                ...
                className="border border-white/10 p-8 flex flex-col items-center justify-center text-center hover:bg-white/5 transition-colors duration-500 group"
                data-testid={`location-${loc.replace(/\s+/g, "-").toLowerCase()}`}
              >
                <MapPin className="w-6 h-6 text-primary mb-4 group-hover:scale-110 transition-transform duration-500" strokeWidth={1.5} />
                <h3 className="text-base md:text-lg font-serif text-white mb-2">{loc}</h3>
                <div className="w-0 h-[1px] bg-primary group-hover:w-10 transition-all duration-500" />
              </motion.div>
            ))}
          </div>
        </div>
              ...
              <form onSubmit={handleWhatsAppSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={handleInputChange}
                      className="bg-transparent border-white/10 rounded-none h-12 text-white focus-visible:ring-primary focus-visible:border-primary placeholder:text-white/20"
                      placeholder="e.g. ₹5 Cr or ₹1.5L/month"
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    className="bg-transparent border-white/10 rounded-none h-12 text-white focus-visible:ring-primary focus-visible:border-primary placeholder:text-white/20"
                    placeholder="e.g. Greater Kailash, Vasant Vihar..."
                ...
                <Button
                  type="submit"
                  className="w-full bg-primary text-primary-foreground hover:bg-primary/90 rounded-none h-14 uppercase tracking-widest text-sm font-semibold group mt-4"
      ...
      <footer className="bg-background border-t border-white/10 pt-20 pb-10">
        <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/5 text-white/30 text-xs font-light uppercase tracking-widest gap-4">
            <p>© 2026 ANOVA Realtors. All Rights Reserved.</p>
